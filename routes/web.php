...
// use App\Http\Controllers\Items\RawItemController;
// use App\Http\Controllers\Items\RawItemTransactionController;
use App\Http\Controllers\RawItems\RawItemsController;
use App\Http\Controllers\RawItems\ItemPurchaseController as RawItemPurchaseController;
use App\Http\Controllers\RawItems\ItemCategoryController as RawItemCategoryController;
...
use App\Http\Controllers\Transaction\OnlineController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'party'], function () {
        ...
        Route::get('/getimage/{image_name?}', function($image_name=null){
            $imagePath = 'public/images/party/avatar/' . $image_name;
            if ($image_name==null || !Storage::exists($imagePath)) {
    ...
    Route::group(['prefix' => 'item-dispatch'], function () {
        Route::get('/create', [ItemDispatchController::class, 'create'])
                ->middleware('can:item.dispatch.create')
                ->name(name: 'item_dispatch.create');//Create

        Route::get('/transaction/{id}', [ItemDispatchController::class, 'transaction'])
                ->middleware('can:item.dispatch.create')
                ->name('item_dispatch.transaction');
        Route::get('/list', [ItemDispatchController::class, 'list'])
                ->middleware('can:item.dispatch.view')
        ...
        Route::get('/edit/{id}', [ItemDispatchController::class, 'edit'])
                ->middleware('can:item.dispatch.create')
                ->name('item_dispatch.edit');

        Route::put('/update', [ItemDispatchController::class, 'store'])->name('item_dispatch.update'); //Update
    ...
    Route::group(['prefix' => 'expense'], function () {
     ...
     Route::group(['prefix' => 'raw-items'], function () {
        /**
         * Raw Item Category Master
        */
        Route::get('/category/create', [RawItemCategoryController::class, 'create'])->middleware('can:raw_items.category.create')->name('raw_items.category.create');//View
        Route::get('/category/edit/{id}', [RawItemCategoryController::class, 'edit'])->middleware('can:raw_items.category.edit')->name('raw_items.category.edit'); //Edit
        Route::put('/category/update', [RawItemCategoryController::class, 'update'])->name('raw_items.category.update'); //Update
        Route::get('/category/list', [RawItemCategoryController::class, 'list'])->middleware('can:raw_items.category.view')->name('raw_items.category.list'); //List
        Route::get('/category/datatable-list', [RawItemCategoryController::class, 'datatableList'])->name('raw_items.category.datatable.list'); //Datatable List
        Route::post('/category/store', [RawItemCategoryController::class, 'store'])->name('raw_items.category.store');//Save operation
        Route::post('/category/delete/', [RawItemCategoryController::class, 'delete'])->middleware('can:raw_items.category.delete')->name('raw_items.category.delete');//delete operation


        Route::get('/create', [RawItemsController::class, 'create'])
                ->middleware('can:raw_items.create')
                ->name('raw_items.create');//View
        Route::get('/edit/{id}', [RawItemsController::class, 'edit'])
                ->middleware('can:raw_items.edit')
                ->name('raw_items.edit'); //Edit
        Route::put('/update', [RawItemsController::class, 'store'])->name('raw_items.update'); //Update
        Route::get('/list', [RawItemsController::class, 'list'])
                ->middleware('can:raw_items.view')
                ->name('raw_items.list'); //List
        Route::get('/datatable-list', [RawItemsController::class, 'datatableList'])->name('raw_items.datatable.list'); //Datatable List
        Route::post('/store', [RawItemsController::class, 'store'])->name('raw_items.store');//Save operation
        Route::post('/delete/', [RawItemsController::class, 'delete'])->name('raw_items.delete')->middleware('can:raw_items.delete');//delete operation

        Route::get('/transaction/{id}', [RawItemsController::class, 'list'])
                    ->middleware('can:raw_items.view')
                    ->name('raw_items.transaction.list');
        Route::get('/transaction-list', [RawItemsController::class, 'datatableList']); //Datatable List

        Route::get('/getimage/{image_name?}', function($image_name=null){
            $imagePath = 'public/images/raw_items/' . $image_name;
            if ($image_name==null || !Storage::exists($imagePath)) {
                return redirect('/noimage');
            }
            return response()->file(Storage::path($imagePath));
        ...
        Route::get('/purchase/create', [RawItemPurchaseController::class, 'create'])
                ->middleware('can:raw_items.purchase.create')
                ->name('raw_items.purchase.create');//View
        Route::get('/purchase/edit/{id}', [RawItemPurchaseController::class, 'edit'])
                ->middleware('can:raw_items.purchase.edit')
                ->name('raw_items.purchase.edit'); //Edit
        Route::put('/purchase/update', [RawItemPurchaseController::class, 'store'])->name('raw_items.purchase.update'); //Update
        Route::get('/purchase/list', [RawItemPurchaseController::class, 'list'])
                ->middleware('can:raw_items.purchase.view')
                ->name('raw_items.purchase.list'); //List
        Route::get('/purchase/details/{id}', [RawItemPurchaseController::class, 'details'])
                    ->middleware('can:raw_items.purchase.view')
                    ->name('raw_items.purchase.details');
        Route::get('/purchase/print/{id}', action: [RawItemPurchaseController::class, 'print'])
                    ->middleware('can:raw_items.purchase.view')
                    ->name('raw_items.purchase.print');
        Route::get('/purchase/thermal-print/{id}', [RawItemPurchaseController::class, 'thermalPrint'])
                    ->middleware('can:raw_items.purchase.view')
                    ->name('raw_items.purchase.thermal-print');
        Route::get('/purchase/pdf/{id}', [RawItemPurchaseController::class, 'generatePdf'])
                    ->middleware('can:raw_items.purchase.view')
                    ->name('raw_items.purchase.pdf');
        Route::get('/purchase/datatable-list', [RawItemPurchaseController::class, 'datatableList'])->name('raw_items.purchase.datatable.list'); //Datatable List
        Route::post('/purchase/store', [RawItemPurchaseController::class, 'store'])->name('raw_items.purchase.store');//Save operation
        Route::post('/purchase/delete/', [RawItemPurchaseController::class, 'delete'])->middleware('can:raw_items.purchase.delete')->name('raw_items.purchase.bill.delete');//delete operation
    });
    ...
    Route::group(['prefix' => 'import'], function () {
       Route::get('/items', [ImportController::class, 'items'])
        ...
        Route::get('/itemCustomerPrice', [ImportController::class, 'itemCustomerPrice'])->name('import.items.customerPrice');//Save operation
        Route::get('/itemUpdation', [ImportController::class, 'itemUpdation'])->name('import.items.updation');//Save operation
   });
    ...
    Route::group(['prefix' => 'sale/order'], function () {
        ...
        Route::get('/posPrint/{id}', [SaleOrderController::class, 'posPrint'])
                    ->middleware('can:sale.order.view')
                    ->name('sale.order.pos.print');
        /**
         * Email
         * */
    ...
    Route::group(['prefix' => 'sale/return'], function () {
        ...
        Route::get('/posPrint/{id}', [SaleReturnController::class, 'posPrint'])
                    ->middleware('can:sale.return.view')
                    ->name('sale.return.pos.print');
        /**
         * Email
         * */
    ...
    Route::group(['prefix' => 'payment/'], function () {
        ...
        Route::post('/sale-invoice/store', [SalePaymentController::class, 'storeSaleBillPayment'])->name('store.sale.payment');//Save operation
        //get payment history
        ...
        Route::get('/sale-invoice/getimage/{image_name?}', function($image_name=null){
                $imagePath = 'public/sale/pos/' . $image_name;
                if ($image_name==null || !Storage::exists($imagePath)) {
                        return redirect('noimage');
                }
                return response()->file(Storage::path($imagePath));
        ...
        Route::get('/sale-invoice/summary/{id}', [SalePaymentController::class, 'invoiceSummary'])
                ->middleware('can:sale.invoice.view');
        Route::get('/sale-invoice/detail/{id}', [SalePaymentController::class, 'invoicePaymentDetail'])
                ->middleware('can:sale.invoice.view');
    ...
    Route::group(['prefix' => 'transaction/'], function () {
        ...
        Route::get('/online/list', [OnlineController::class, 'list'])
                ->middleware('can:transaction.online.view')
                ->name('transaction.online.list'); //List
         ...
         Route::get('/online/datatable-list', [OnlineController::class, 'datatableList']); //Datatable List
