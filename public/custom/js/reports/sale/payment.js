$(function() {
    ...
    function formAdjustIfSaveOperation(response){
        ...
        $.each(response.data, function(index, item) {
            ...
            var attachment = '';
            if(item.attachment) {
                attachment = `<a download href="${baseURL}/payment/sale-invoice/getimage/${item.attachment}" target="_blank" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Download"><i class="bx bxs-download"></i></a>`;
            }
                ...
                <tr>
                    ...
                    <td>   
                        <div class="d-flex order-actions justify-content-center">
                            <a href="${baseURL}/sale/invoice/details/${item.invoice_id}" target="_blank" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Invoice"><i class="bx bx-show-alt"></i></a>
                            ${attachment}
                        </div>
                    </td>
                </tr>
    ...
    $(document).on("click", '#generate_pdf', function() {
        tableId.tableExport({type:'pdf',escape:'false',fileName: 'Sale-Payments-Report',});
    });
