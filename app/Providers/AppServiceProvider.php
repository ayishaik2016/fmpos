...
use App\Models\RawItem\Purchase as RawItemPurchase;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        if(env('INSTALLATION_STATUS')){
            ...
            $this->app->singleton('site', function () {
                ...
                $appSettings = AppSettings::find(App::APP_SETTINGS_RECORD_ID->value);
                return [
    ...
    public function boot(): void
    {
        ...
        Relation::morphMap([
            ...
            'Raw Item Opening'          =>  RawItems::class, //Used in ItemTransaction class,

            'Raw Item Purchase'          =>  RawItemPurchase::class, //Used in ItemTransaction class,
