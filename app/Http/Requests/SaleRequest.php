...
class SaleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rulesArray = [
            ...
            'return_sale'          => ['nullable', 'numeric'],
            'return_sale_amount'   => ['nullable', 'numeric'],
            'sales_return_id'      => ['nullable', 'numeric']
        ]; 
        
        if($this->input('return_sale') && $this->input('return_sale') == 1) {
            $rulesArray['return_sale_amount'] = ['required'];
            $rulesArray['sales_return_id'] = ['required'];
        }
