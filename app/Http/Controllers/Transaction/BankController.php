...
{   
    ...
    public function datatableList(Request $request){
        ...
        $data = PaymentTransaction::with('user', 'paymentType')
                                    ->where(function ($query) use ($cashId, $chequeId, $onlineId) {
                                        $query->whereNotIn('payment_type_id', [$cashId, $chequeId, $onlineId])
                                              ->orWhereNotIn('transfer_to_payment_type_id', [$cashId, $chequeId, $onlineId]);
                                    })
