...
use App\Models\RawItems\Item as RawItems;
use App\Models\RawItems\ItemTransaction as RawItemsTransaction;
use App\Models\Tax;
use App\Models\Unit;
use Carbon\Carbon;
...
class RawItemsController extends Controller
{
    ...
    public function create()  {
        ...
        $data = [
            ...
            'sequence_no' => 10000 + $this->getLastCountId() + 1
        ];
        return view('raw-items.item.create', compact('data'));
    }
    /**
     * Get last count ID
     * */
    ...
    public function edit($id) : View {
        ...
        return view('raw-items.item.edit', compact('item', 'transaction', 'todaysDate'));
    }
    ...
    public function recordInItemTransactionEntry($request)
    {
        ...
        $transaction = RawItemsTransaction::create([
            'transaction_type' => 'Item Opening',
            ...
            'quantity' => $request->opening_quantity ?? 0,
    ...
    public function list() : View {
        return view('raw-items.item.list');
    }
