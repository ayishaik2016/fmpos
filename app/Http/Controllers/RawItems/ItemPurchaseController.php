...
class ItemPurchaseController extends Controller
{
    ...
    public function create(): View  {
        ...
        $data = [
            'prefix_code' => $prefix->raw_item_purchase,
            'count_id' => ($lastCountId+1),
        ];
        return view('raw-items.purchase.create',compact('data', 'selectedPaymentTypesArray'));
    }
    ...
    public function list() : View {
        return view('raw-items.purchase.list');
    }
    ...
    public function convertToPurchase($id) : View | RedirectResponse {
        ...
        return view('raw-items.purchase.edit', compact('taxList', 'purchase', 'itemTransactionsJson','selectedPaymentTypesArray', 'paymentHistory'));
    }
    ...
    public function details($id) : View {
        ...
        return view('raw-items.purchase.details', compact('purchase','selectedPaymentTypesArray', 'batchTrackingRowCount'));
    }
