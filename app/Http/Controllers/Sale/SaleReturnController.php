...
class SaleReturnController extends Controller
{
    ...
    public function posPrint($id, $isPdf = false) : View {
        ...
        $sale = SaleReturn::with(['party','user',
                                        'itemTransaction' => [
                                            'item'
                                        ]])->findOrFail($id);
        //Payment Details
        ...
        return view('print.sale-return.pos.print', compact('isPdf', 'invoiceData', 'sale','selectedPaymentTypesArray','batchTrackingRowCount', 'currencyDetail'));
    ...
    public function datatableList(Request $request){
        ...
        return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                            ...
                            $printUrlPOS = route('sale.return.pos.print', ['id' => $id]);
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a target="_blank" class="dropdown-item" href="' . $printUrlPOS . '"></i><i class="bx bx-printer "></i> '.__('sale.pos_print').'</a>
                                </li>
                                <li>
