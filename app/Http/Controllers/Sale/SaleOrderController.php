...
class SaleOrderController extends Controller
{
    ...
    public function posPrint($id, $isPdf = false) : View {
        ...
        $sale = SaleOrder::with(['party','user',
                                        'itemTransaction' => [
                                            'item',
                                            'tax',
                                            'batch.itemBatchMaster',
        ...
        return view('print.sale-order.pos.print', compact('isPdf', 'invoiceData', 'sale','selectedPaymentTypesArray','batchTrackingRowCount', 'currencyDetail'));
    ...
    public function datatableList(Request $request){
        ...
        return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                            ...
                            $printUrlPOS = route('sale.order.pos.print', ['id' => $id]);
