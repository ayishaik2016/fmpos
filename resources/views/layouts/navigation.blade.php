<!--sidebar wrapper -->
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				@canany(['raw_items.create', 'raw_items.view', 'item.category.create', 'item.category.view', 'raw_items.purchase.create', 'raw_items.purchase.view'])
				<li>
					<a href="javascript:;" class="has-arrow">
						<div class="parent-icon"><i class="bx bx-package"></i>
						</div>
						<div class="menu-title">{{
						__('raw_item.raw_items') }}</div>
					</a>
					<ul>
						@can('raw_items.view')
							<li class="{{ request()->is('raw-items/list', 'raw-items/create', 'raw-items/edit*', 'raw-items/transaction*') ? 'mm-active' : '' }}">
								<a href="{{ route('raw_items.list') }}"><i class='bx bx-radio-circle'></i>{{ __('raw_items.list') }}</a>
							</li>
						@endcan

						@can('raw_items.category.view')
							<li class="{{ request()->is('raw-items/category/*', 'raw-items/category/*') ? 'mm-active' : '' }}">
								<a href="{{ route('raw_items.category.list') }}"><i class='bx bx-radio-circle'></i>{{ __('raw_items.category.list') }}</a>
							</li>
						@endcan

						@can('raw_items.purchase.view')
							<li class="{{ request()->is('raw-items/purchase/*') ? 'mm-active' : '' }}">
								<a href="{{ route('raw_items.purchase.list') }}"><i class='bx bx-radio-circle'></i>{{ __('raw_items.purchase') }}</a>
							</li>
						@endcan
					</ul>
				</li>
				...
				@canany(['transaction.cash.view', 'transaction.cheque.view', 'transaction.online.view', 'transaction.bank.view'])
				<li>
					<a href="javascript:;" class="has-arrow">
					...
					<ul>
						...
						@can('transaction.online.view')
						<li class="{{ request()->is('transaction/online/list') ? 'mm-active' : '' }}">
											<a href="{{ route('transaction.online.list') }}"><i class='bx bx-radio-circle'></i>{{ __('payment.online') }}</a>
										</li>
						@endcan
