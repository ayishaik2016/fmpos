        ...
        <table class="table-bordered custom-table table-compact" id="item-table">
            ...
            <tfoot>
                ...
                @php
                    ...
                    $noteRosSpan = 3 - ((app('company')['tax_type'] =='no-tax') ? 1 : 0);
                ...
                <tr>
                    <td colspan="{{ $noteColumns }}" rowspan="{{ $amountInWordsRowSpan }}" class="tfoot-first-td">
                        ...
                        {{ ucwords($formatNumber->formatWithPrecision($sale->grand_total)) }}
                    </td>
                    <td colspan="2" class="text-end fw-bold">{{ __('sale.sale_return') }}(-)</td>
                    <td colspan="1" class="text-end">{{$formatNumber->formatWithPrecision($sale->return_sale_amount)}}</td>
                </tr>
