...
<div class="modal fade" id="invoicePaymentModal" >
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class=" needs-validation" method="post" id="paymentForm" action="{{ url('payment/'. $payment_for.'/store' ) }}" enctype="multipart/form-data">
                {{-- CSRF Protection --}}
                @csrf
                @method('POST')
                <div class="modal-body row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select select2 payment-type-ajax" id="payment_type_id" name="payment_type_id" data-placeholder="Choose one thing"></select>
                        </div>
                        <div class="col-md-6">
