        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="card-header px-4 py-3 d-flex justify-content-between">
                        ...
                        <x-anchor-tag href="{{ route('raw_items.purchase.create') }}" text="{{ __('purchase.create') }}" class="btn btn-primary px-5" />
                        @endcan
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
...
<script src="{{ versionedAsset('custom/js/raw-items/purchase/purchase-bill-list.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/modals/payment/invoice-payment.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/modals/email/send.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/sms/sms.js?v=' . config('constants.version')) }}"></script>
@endsection
