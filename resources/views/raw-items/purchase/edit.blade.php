                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            <div class="col-md-3 col-sm-12 col-lg-2">
                                                ...
                                                <x-dropdown-item-category selected="" :isMultiple="false" :showSelectOptionAll="false" selectedCategories="{{ 'purchase_category' }}" />
                                            </div>
...
<script src="{{ versionedAsset('custom/js/purchase/purchase-bill.js?v=' . config('constants.version')) }}"></script>
...
<script src="{{ versionedAsset('custom/js/modals/purchase/order/load-purchased-items.js?v=' . config('constants.version')) }}"></script>
@endsection
