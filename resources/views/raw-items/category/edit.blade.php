@extends('layouts.app')
@section('title', __('raw_items.category.update'))
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-header px-4 py-3">
                                <h5 class="mb-0">{{ __('raw_items.category.details') }}</h5>
                            </div>
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="itemCategoryForm" action="{{ route('raw_items.category.update') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
                                    @csrf
                                    @method('PUT')
...
@section('js')
<script src="{{ versionedAsset('custom/js/raw-items/item-category.js') }}"></script>
@endsection
