                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4 row g-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <x-label for="invoice_number" name="{{ __('sale.invoice_no') }}" />
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select payment-type-ajax" data-placeholder="Select Payment Type" id="payment_type_id" name="payment_type_id"></select>
                                        </div>
                                        <div class="col-md-6 mb-3">
...
@section('js')
    ...
    <script src="{{ versionedAsset('custom/js/reports/sale/payment.js?v=' . config('constants.version')) }}"></script>
