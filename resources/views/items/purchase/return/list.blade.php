                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <x-dropdown-user selected="" :showOnlyUsername='true' :canViewAllUsers="auth()->user()->can('purchase.return.can.view.other.users.purchase.returns')" />
                            </div>
                            <div class="col-md-3">
...
<script src="{{ versionedAsset('custom/js/purchase/purchase-return-list.js') }}"></script>
