                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="itemForm" action="{{ route('item.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <x-dropdown-item-category selected="" :isMultiple=false selectedCategories="{{ 'sale_category' }}"/>
                                            ...
                                            <div class="row">
                                                @if(in_array(auth()->user()->role_id, config('constants.purchase_price_access'))) 
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <x-input type="text" name="purchase_price" :required="false" additionalClasses='cu_numeric fw-bold bg-light-success' value=""/>
                                                ...
                                                @else
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="hidden" name="is_purchase_price_with_tax" value="0"/>
                                                    </div>
                                                @endif
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <x-input type="text" name="profit_margin" :required="false" additionalClasses='cu_numeric fw-bold bg-light-success' value=""/>
                                                </div>

                                                <div class="col-md-4">
                                                    <x-label for="sale_price" name="{{ __('item.sale_price') }}" />
                                                    <div class="input-group mb-3">
                                                        <x-input type="text" name="sale_price" :required="true" additionalClasses='cu_numeric fw-bold bg-light-success' value="0"/>
...
@section('js')
<script src="{{ versionedAsset('custom/js/items/item.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/items/serial-tracking.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/items/batch-tracking.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/modals/tax/tax.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/modals/item/brand/brand.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/modals/item/category/category.js?v=' . config('constants.version')) }}"></script>
<script src="{{ versionedAsset('custom/js/modals/unit/unit.js?v=' . config('constants.version')) }}"></script>
@endsection
