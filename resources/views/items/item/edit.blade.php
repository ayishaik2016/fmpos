                                    ...
                                    <div class="tab-content py-3">
                                        <div class="tab-pane fade show active" id="successhome" role="tabpanel">
                                            <div class="row">
                                                ...
                                                @else
                                                    <div class="input-group mb-3">
                                                        <input type="hidden" name="purchase_price" value="{{ $formatNumber->formatWithPrecision($item->purchase_price, comma:false) }}"/>
                                                        <input type="hidden" name="is_purchase_price_with_tax" value="{{ $item->is_purchase_price_with_tax }}"/>
                                                    </div>
                                                @endif
                                                <div class="col-md-4">
...
<script src="{{ versionedAsset('custom/js/items/item-edit.js?v=' . config('constants.version')) }}"></script>
