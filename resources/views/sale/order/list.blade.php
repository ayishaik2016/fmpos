...
<script src="{{ versionedAsset('custom/js/sale/sale-order-list.js?v=' . config('constants.version')) }}"></script>
...
<script src="{{ versionedAsset('custom/js/modals/status-history/status-history.js?v=' . config('constants.version')) }}"></script>
@endsection
