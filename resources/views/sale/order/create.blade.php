                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            @can('sale.invoice.item.dispatch')
                                                ...
                                                <div class="col-md-3 col-sm-12 col-lg-2">
                                                    <x-label for="item_dispatch_id" name="{{ __('warehouse.item_dispatch') }}" />
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <td colspan="3" class="fw-bold text-end tfoot-first-td">
                                                                {{ __('app.total_quantity') }}
                                                            </td>
                                                            <td colspan="2" class="fw-bold sum_of_quantity text-end">
                                                                0
                                                            </td>
                                                            <td class="fw-bold text-end" colspan="2">{{ __('app.total_amount') }}</td>
                                        ...
                                        <div class="payment-container">
                                            <div class="row payment-type-row-0 py-3 ">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <x-input type="text" :readonly="true" additionalClasses="cu_numeric" name="payment_amount[0]" value=""/>
...
<script src="{{ versionedAsset('custom/js/sale/sale-order.js?v=' . config('constants.version')) }}"></script>
...
<script src="{{ versionedAsset('custom/js/modals/payment-type/payment-type.js?v=' . config('constants.version')) }}"></script>
...
<script src="{{ versionedAsset('custom/js/modals/sale/order/load-sold-items.js?v=' . config('constants.version')) }}"></script>
