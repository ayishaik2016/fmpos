                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <x-dropdown-user selected="" :showOnlyUsername='true' :canViewAllUsers="auth()->user()->can('sale.return.can.view.other.users.sale.returns')" />
                            </div>
                            <div class="col-md-3">
...
<script src="{{ versionedAsset('custom/js/sale/sale-return-list.js') }}"></script>
