                    ...
                    <div class="card-body">
                        <div class="toolbar hidden-print">
                                <div class="text-end">
                                    ...
                                    <a href="{{ route('sale.return.pos.print', ['id' => $return->id]) }}" target="_blank" class="btn btn-outline-secondary px-4"><i class="bx bx-printer mr-1"></i>{{ __("app.thermal_print") }}</a>
