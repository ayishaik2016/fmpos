<tr>
                                                ...
                                                <tr>
                                                    <td class="group-name">{{ __('vehicle.vehicle') }}</td>
                                                    <td>
                                                        <input class="form-check-input row-select" type="checkbox" id="vehicle_group">
                                                        <label for="vehicle_group">{{ __('app.select_all') }}</label>
                                                    </td>
                                                    <td>
                                                        <input class="form-check-input vehicle_group_p" type="checkbox" name="permission[vehicle.create]" id="vehicle.create">
                                                        <label for="vehicle.create">{{ __('app.create') }}</label>
                                                        <br>
                                                        <input class="form-check-input vehicle_group_p" type="checkbox" name="permission[vehicle.edit]" id="vehicle.edit">
                                                        <label for="vehicle.edit">{{ __('app.edit') }}</label>
                                                        <br>
                                                        <input class="form-check-input vehicle_group_p" type="checkbox" name="permission[vehicle.view]" id="vehicle.view">
                                                        <label for="vehicle.view">{{ __('app.view') }}</label>
                                                        <br>
                                                        <input class="form-check-input vehicle_group_p" type="checkbox" name="permission[vehicle.delete]" id="vehicle.delete">
                                                        <label for="vehicle.delete">{{ __('app.delete') }}</label>
                                                        <br>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="group-name">{{ __('warehouse.stock_dispatch') }}</td>
                                                    <td>
                                                            <input class="form-check-input row-select" type="checkbox" id="stock_dispatch_group">
                                                            <label for="stock_dispatch_group">{{ __('app.select_all') }}</label>
                                                    </td>
                                                    <td>
                                                        <input class="form-check-input stock_dispatch_group_p" type="checkbox" name="permission[item.dispatch.create]" id="item.dispatch.create">
                                                        <label for="item.dispatch.create">{{ __('app.create') }}</label>
                                                        <br>
                                                        <input class="form-check-input stock_dispatch_group_p" type="checkbox" name="permission[item.dispatch.view]" id="item.dispatch.view">
                                                        <label for="item.dispatch.view">{{ __('app.view') }}</label>
                                                        <br>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <br>
                                                        <input class="form-check-input cash_and_bank_transaction_group_p" type="checkbox" name="permission[transaction.online.view]" id="transaction.online.view">
                                                        <label for="transaction.cheque.view">{{ __('payment.online_transaction_view') }}</label>
                                                        <br>
                                                    </td>
                                                </tr>
                                                <tr>
