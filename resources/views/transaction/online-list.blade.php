@extends('layouts.app')
@section('title', __('payment.online_transactions'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="card-header px-4 py-3 d-flex justify-content-between">
                        ...
                        <div>
                            <h5 class="mb-0 text-uppercase">{{ __('payment.online_transactions') }}</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
...
<script src="{{ versionedAsset('custom/js/transaction/online-transaction-list.js') }}"></script>
@endsection
